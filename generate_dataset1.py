...
img_folder_pth = './datasets/dataset_10000_more_angles_green/dataset_change_bg/'  # yy: dataset path containing the rgb images
# keypoints_folder_pth = './dataset_1000/final_imgs/kp/'  # yy: keypoints path containing the keypoints info
colored_mh_pth = './datasets/dataset_10000_more_angles_green/bicolor_hand/'  # yy: path to the generated minimal hands (defined in generate_mh_info.py)
skeleton_pth = './dataset_change_bg_6_channels/'  # yy: path to save the generated dataset
cubes_mh_pth = './datasets/dataset_10000_more_angles_green/cubes/'
kp_pth = './datasets/dataset_10000_more_angles_green/kp/'
